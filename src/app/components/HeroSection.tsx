      ...
      <div className="relative z-10 flex flex-col justify-center w-full max-w-7xl px-8 md:px-16 lg:px-24 pointer-events-none">
        ...
        >
          <h1
            ...
            style={{ color: textColor, lineHeight: 1.1, opacity: 0.9, textShadow: "0 4px 12px rgba(0,0,0,0.5)" }}
          >
            {t.name} {/* 🌟 动态名称 */}
          </h1>
        </div>
        ...
        <div
          ...
          style={{ ...getCrystalGlassStyle(darkMode), borderRightColor: "transparent", WebkitMaskImage: "linear-gradient(to right, black 70%, transparent 100%)", maskImage: "linear-gradient(to right, black 70%, transparent 100%)", width: "max-content", maxWidth: "90vw" }}
        >
          <p
            ...
            style={{ color: textColor, paddingRight: "6rem", opacity: 0.9, textShadow: "0 2px 8px rgba(0,0,0,0.4)" }}
          >
            {t.subtitle} {/* 🌟 动态头衔 */}
          </p>
        </div>
