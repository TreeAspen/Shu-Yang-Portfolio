...
export function ContactSection({ darkMode }: ContactSectionProps) {
  return (
    <section
      ...
      style={{
        // changed black/dark blue to purple
        backgroundColor: darkMode ? "#3b1e68" : "#f5f0ff",
      }}
    >
      {/* Elliptical yellow shape */}
      <motion.div
        ...
        style={{
          backgroundColor: darkMode ? "#fcf896" : "#ede4f7",
          zIndex: 0,
        }}
      />
      ...
      <div className="relative z-10 text-center max-w-5xl mx-auto">
        ...
        <motion.div
          ...
          style={{
            backgroundColor: darkMode ? "rgba(80, 50, 130, 0.95)" : "rgba(80, 50, 130, 0.9)",
          }}
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 relative z-10">
            <motion.div whileHover={{ scale: 1.05 }} className="flex flex-col items-center gap-5 p-6 rounded-3xl hover:bg-white/5 transition-colors">
              <div
                ...
                style={{ backgroundColor: "rgba(255, 250, 116, 0.15)", border: "1px solid rgba(255, 250, 116, 0.3)" }}
              >
                <Mail size={36} color="#fffa74" />
              </div>
              <h3
                className="font-['Jaro',sans-serif] text-3xl"
                style={{ color: "#fffa74" }}
              >
                Email
              </h3>
              <a
                href="mailto:sy4234@nyu.edu"
      ...
      <div className="relative z-10 text-center mt-24 pb-8">
        <p
          className="font-['Jaro',sans-serif] text-lg opacity-60 tracking-wider"
          style={{ color: darkMode ? "#fffa74" : "#503282" }}
        >
          &copy; 2026 Shu Yang. All rights reserved.
        </p>
      </div>
    </section>
  );
